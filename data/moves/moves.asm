...
; Characteristics of each move.
	...
	move RAZOR_WIND,   NO_ADDITIONAL_EFFECT,        80, BUG,          100, 15
	...
	move FLY,          NO_ADDITIONAL_EFFECT,        85, FLYING,        95, 15
	move BIND,         TRAPPING_EFFECT,             15, NORMAL,        85, 20
	move SLAM,         NO_ADDITIONAL_EFFECT,        65, NORMAL,       100, 25
	...
	move STRENGTH,     DEFENSE_DOWN_SIDE_EFFECT,    90, FIGHTING,     100, 15
	...
	move POISONPOWDER, POISON_EFFECT,                0, GRASS,         90, 35
	move STUN_SPORE,   PARALYZE_EFFECT,              0, GRASS,         85, 30
	move SLEEP_POWDER, SLEEP_EFFECT,                 0, GRASS,         75, 15
	move PETAL_DANCE,  CONFUSION_SIDE_EFFECT,       90, GRASS,        100, 15
	...
	move SCREECH,      DEFENSE_DOWN2_EFFECT,         0, NORMAL,        90, 30
	move DOUBLE_TEAM,  EVASION_UP1_EFFECT,           0, NORMAL,       100, 15
	move RECOVER,      HEAL_EFFECT,                  0, NORMAL,       100, 20
	move HARDEN,       DEFENSE_UP1_EFFECT,           0, NORMAL,       100, 40
	...
	move SKY_ATTACK,   JUMP_KICK_EFFECT,           100, FLYING,        90, 10
	...
	move ROCK_SLIDE,   NO_ADDITIONAL_EFFECT,        90, ROCK,         100, 15
